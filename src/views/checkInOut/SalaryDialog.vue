...
<template>
  <v-dialog v-model="checkInOutStore.salaryDialog" persistent width="600">
    <v-sheet
      elevation="15"
      max-width="600"
      rounded="lg"
    ...
    >
      ...
      <v-card-text>
        <v-form ref="form">
          <v-container>
            <v-row>
              <v-col cols="10">
                <v-select persistent-hint return-object single-line></v-select>
                <v-btn>Ok</v-btn>
              </v-col>
      ...
      <v-card-actions class="mb-0">
        ...
        <v-btn
          color="red"
          variant="text"
          @click="checkInOutStore.salaryDialog = false"
        >
          Close
        </v-btn>
      </v-card-actions>
